...
workbook = xlsxwriter.Workbook('target_wiki_permissions.xlsx')
...
def main():
    for _, row in input_data.iterrows():
        ...
        worksheet = workbook.add_worksheet(target_project_name[:31])  # Excel sheet name limit is 31 characters
        print(f"Processing permissions for Project: {target_project_name}")

        get_explicit_identities(target_ado_server_url, target_project_name, target_pat, worksheet)
