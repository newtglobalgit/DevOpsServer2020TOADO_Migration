...
from src.models.delivery_plan_model import  TargetDeliveryPlanDetails
...
def db_post_delivery_plan(all_records):
    ...
    try:
        for data in all_records:
            ...
            # Create a new record
            new_record = TargetDeliveryPlanDetails(
                collection_name=collection_name,
                project_name=project_name,
                delivery_plan_id = delivery_plan_id,
                delivery_plan_revision =delivery_plan_revision,
...
def db_get_delivery_plan():
    ...
    try:
        with SessionLocal() as db:
            ...
            records = db.query(TargetDeliveryPlanDetails).all()
