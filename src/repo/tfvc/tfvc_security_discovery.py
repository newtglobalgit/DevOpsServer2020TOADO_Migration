...
def get_explicit_identities(ado_server_url, project_name, pat, worksheet):
    ...
    try:
        ...
        for branch in branch_list:
            ...
            payload = get_payload(ado_server_url , project_name , collection_id, branch)
            headers = {
                "Content-Type": "application/json",
            ...
            if response.status_code == 200:
                ...
                for identity in identities:
                    ...
                    payload =get_payload_1(ado_server_url, project_name ,collection_id , descriptor, branch)
...
if __name__ == "__main__":
    ...
    clean_table("devops_to_ados","db_devops_discovery_tfvc_security","y")
    main()